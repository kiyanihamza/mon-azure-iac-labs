...
# ==========================================
# 3. CRÉATION DES RESSOURCES DE LA VM WINDOWS
# ==========================================

# Génération d'un mot de passe d'administration robuste et aléatoire
...
# Interface réseau (NIC) liant la VM au sous-réseau et à l'IP publique
...
# La Machine Virtuelle Windows Server
